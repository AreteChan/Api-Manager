...
const { createApi, getApis, getApiDetail, deleteApi, updateApi, swaggerHandler } = require('../controllers/apiController')
...
router.post('/project/:id/swagger', protect, swaggerHandler)
